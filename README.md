...
<br />
<p align="center">
  <a href="https://github.com/mustaqimarifin/zod-prisma">
    <img src="https://raw.githubusercontent.com/mustaqimarifin/zod-prisma/main/images/zod-prisma.svg" alt="Logo" width="120" height="120">
  </a>
  <h3 align="center">Zod Prisma</h3>
  <p align="center">
    A custom prisma generator that creates Zod schemas from your Prisma model.
    <br />
    <a href="https://github.com/mustaqimarifin/zod-prisma"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/mustaqimarifin/zod-prisma/blob/main/src/test/functional">View Demo</a>
    ·
    <a href="https://github.com/mustaqimarifin/zod-prisma/issues">Report Bug</a>
    ·
    <a href="https://github.com/mustaqimarifin/zod-prisma/issues">Request Feature</a>
  </p>
</p>
...
1. Add zod-prisma as a dev dependency
    ...
    ```sh
    yarn add -D @kaviartaco/zod-prisma
    ```
...
_For examples, please refer to the [Examples Directory](https://github.com/mustaqimarifin/zod-prisma/blob/main/examples) or the [Functional Tests](https://github.com/mustaqimarifin/zod-prisma/blob/main/src/test/functional)_

<!-- ROADMAP -->

## Roadmap

See the [open issues](https://github.com/mustaqimarifin/zod-prisma/issues) for a list of proposed features (and known issues).
...
Project Link: [https://github.com/mustaqimarifin/zod-prisma](https://github.com/mustaqimarifin/zod-prisma)
...
[contributors-shield]: https://img.shields.io/github/contributors/mustaqimarifin/zod-prisma.svg?style=for-the-badge
[contributors-url]: https://github.com/mustaqimarifin/zod-prisma/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/mustaqimarifin/zod-prisma.svg?style=for-the-badge
[forks-url]: https://github.com/mustaqimarifin/zod-prisma/network/members
[stars-shield]: https://img.shields.io/github/stars/mustaqimarifin/zod-prisma.svg?style=for-the-badge
[stars-url]: https://github.com/mustaqimarifin/zod-prisma/stargazers
[issues-shield]: https://img.shields.io/github/issues/mustaqimarifin/zod-prisma.svg?style=for-the-badge
[issues-url]: https://github.com/mustaqimarifin/zod-prisma/issues
[license-shield]: https://img.shields.io/github/license/mustaqimarifin/zod-prisma.svg?style=for-the-badge
[license-url]: https://github.com/mustaqimarifin/zod-prisma/blob/main/LICENSE
